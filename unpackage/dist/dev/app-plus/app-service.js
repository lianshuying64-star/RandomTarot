...
详细信息：${s4}`), (console["warn" === t4 ? "error" : t4] || console.log)(r3);
  ...
  __publicField(SpreadManager, "spreads", {
    // 单张抽牌
    single: {
      name: "单张抽牌",
      cardCount: 1,
  ...
  const _sfc_main$o = {
    ...
    methods: {
      ...
      // 高级设置
      onAlgorithmChange(e2) {
        this.algorithm = e2;
        this.emitSettings();
      },
      onAutoReverseChange(e2) {
        this.autoReverse = e2.detail.value;
        this.emitSettings();
      },
      onDeckTypeChange(e2) {
        this.deckType = e2;
  ...
  function _sfc_render$n(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "draw-settings" }, [
      vue.createVNode(_component_uni_forms_item, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("view", { class: "count-selector" }, [
            vue.createElementVNode("view", { class: "quick-counts" }, [
              (vue.openBlock(true), vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList($data.quickCounts, (count) => {
                  return vue.openBlock(), vue.createElementBlock("button", {
                    key: count,
                    class: vue.normalizeClass(["count-btn", { active: $data.cardCount === count }]),
                    onClick: ($event) => $options.setCardCount(count)
                  }, vue.toDisplayString(count) + "张 ", 11, ["onClick"]);
                }),
                128
                /* KEYED_FRAGMENT */
              ))
            ]),
            vue.createElementVNode("view", { class: "custom-count" }, [
              vue.createElementVNode("text", { class: "custom-label" }, "自定义:"),
              vue.createVNode(_component_uni_number_box, {
                modelValue: $data.customCount,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.customCount = $event),
                min: 1,
                max: $data.maxCards,
                onChange: $options.setCustomCount
      ...
      vue.createVNode(_component_uni_forms_item, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("view", { class: "spread-selector-container" }, [
            vue.createVNode(_component_uni_data_select, {
              modelValue: $data.spreadMode,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.spreadMode = $event),
              localdata: $options.spreadModes,
              onChange: $options.onSpreadModeChange,
              placeholder: "选择牌阵"
            }, null, 8, ["modelValue", "localdata", "onChange"]),
            $options.currentSpread ? (vue.openBlock(), vue.createElementBlock(
              "text",
              {
                key: 0,
                class: "spread-info"
              },
              vue.toDisplayString($options.currentSpread.cardCount) + "张 - " + vue.toDisplayString($options.currentSpread.description),
              1
              /* TEXT */
            )) : vue.createCommentVNode("v-if", true)
          ])
      ...
      vue.createVNode(_component_uni_collapse, null, {
        default: vue.withCtx(() => [
          vue.createVNode(_component_uni_collapse_item, { title: "高级设置" }, {
            default: vue.withCtx(() => [
              vue.createVNode(_component_uni_forms_item, {
                label: "随机算法",
                name: "algorithm"
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_uni_data_select, {
                    modelValue: $data.algorithm,
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.algorithm = $event),
                    localdata: $data.algorithms,
                    onChange: $options.onAlgorithmChange
                  }, null, 8, ["modelValue", "localdata", "onChange"])
                ]),
                _: 1
                /* STABLE */
              ...
              vue.createVNode(_component_uni_forms_item, {
                ...
                default: vue.withCtx(() => [
                  vue.createElementVNode("switch", {
                    checked: $data.autoReverse,
                    onChange: _cache[3] || (_cache[3] = (...args) => $options.onAutoReverseChange && $options.onAutoReverseChange(...args))
                  }, null, 40, ["checked"]),
                  vue.createElementVNode(
                    "text",
                    { class: "switch-label" },
                    vue.toDisplayString($data.autoReverse ? "自动随机" : "全部正位"),
                    1
                    /* TEXT */
                  )
                ]),
              ...
              vue.createVNode(_component_uni_forms_item, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_uni_data_select, {
                    modelValue: $data.deckType,
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.deckType = $event),
                    localdata: $data.deckTypes,
                    onChange: $options.onDeckTypeChange
                  }, null, 8, ["modelValue", "localdata", "onChange"])
                ]),
                _: 1
                /* STABLE */
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "popup-selector" }, [
      vue.createElementVNode("view", {
        ...
        onClick: _cache[0] || (_cache[0] = (...args) => $options.showPopup && $options.showPopup(...args))
      }, [
        vue.createElementVNode(
          "text",
          { class: "trigger-text" },
          vue.toDisplayString($options.selectedText || $props.placeholder),
          1
          /* TEXT */
        ),
        vue.createVNode(_component_uni_icons, {
            ...
            vue.createElementVNode("view", { class: "popup-content" }, [
              ...
              vue.createElementVNode(
                "scroll-view",
                {
                  "scroll-y": "",
                  class: "options-list",
                  style: vue.normalizeStyle({ maxHeight: $props.maxHeight })
                },
                [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    ...
                    vue.renderList($props.options, (item) => {
                      return vue.openBlock(), vue.createElementBlock("view", {
                        key: item.value,
                        class: vue.normalizeClass(["option-item", { active: $props.value === item.value }]),
                        onClick: ($event) => $options.selectOption(item)
                      }, [
                        vue.createElementVNode(
                          "text",
                          { class: "option-text" },
                        ...
                        item.description ? (vue.openBlock(), vue.createElementBlock(
                          "text",
                          {
                            key: 0,
                            class: "option-desc"
                        ...
                        $props.value === item.value ? (vue.openBlock(), vue.createBlock(_component_uni_icons, {
                          key: 1,
                          type: "checkmarkempty",
                          color: "#8B4513"
                        })) : vue.createCommentVNode("v-if", true)
  ...
  const _sfc_main$c = {
    ...
    methods: {
      ...
      emitTimeSeed(e2) {
        this.timeSeed = e2;
        this.currentSeedValue = `时间: ${this.formatTime(e2)}`;
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "seed-input" }, [
      $data.currentSeedValue ? (vue.openBlock(), vue.createBlock(_component_uni_notice_bar, {
        key: 0,
        text: `当前种子: ${$data.currentSeedValue}`,
      ...
      vue.createVNode(_component_uni_forms_item, {
        ...
        default: vue.withCtx(() => [
          vue.createVNode(_component_uni_easyinput, {
            modelValue: $data.numberSeed,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.numberSeed = $event),
            type: "number",
            placeholder: "输入任意数字作为种子",
            onInput: $options.emitNumberSeed,
            clearable: ""
      ...
      vue.createVNode(_component_uni_forms_item, {
        ...
        default: vue.withCtx(() => [
          vue.createVNode(_component_uni_easyinput, {
            modelValue: $data.textSeed,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.textSeed = $event),
            placeholder: "输入中英文文字作为种子",
            onInput: $options.emitTextSeed,
            clearable: ""
          }, null, 8, ["modelValue", "onInput"])
        ]),
        _: 1
      ...
      vue.createVNode(_component_uni_forms_item, {
        ...
        default: vue.withCtx(() => [
          vue.createVNode(_component_uni_easyinput, {
            modelValue: $data.questionSeed,
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.questionSeed = $event),
            type: "textarea",
            placeholder: "输入您的问题，将随机抽取字符生成种子",
            onInput: $options.emitQuestionSeed,
            clearable: ""
          }, null, 8, ["modelValue", "onInput"])
        ]),
        _: 1
      ...
      vue.createVNode(_component_uni_forms_item, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("view", { class: "time-picker-wrapper" }, [
            vue.createVNode(_component_popup_selector, {
              modelValue: $data.timeSeed,
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $data.timeSeed = $event),
      ...
      vue.createElementVNode("view", { class: "quick-seed-buttons" }, [
        vue.createVNode(_component_uni_tag, {
          text: "当前时间",
          type: "primary",
          onClick: $options.useCurrentTime,
          size: "small"
        }, null, 8, ["onClick"]),
        vue.createVNode(_component_uni_tag, {
          text: "随机数字",
          type: "success",
          onClick: $options.useRandomNumber,
          size: "small"
        }, null, 8, ["onClick"]),
        vue.createVNode(_component_uni_tag, {
          text: "清空所有",
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "draw-result" }, [
      $props.spreadConfig ? (vue.openBlock(), vue.createElementBlock("view", {
        ...
        vue.createElementVNode(
          "text",
          { class: "spread-name" },
          vue.toDisplayString($props.spreadConfig.name) + "牌阵",
          1
          /* TEXT */
        ),
        vue.createElementVNode(
          "text",
          { class: "spread-desc" },
          vue.toDisplayString($props.spreadConfig.description),
          1
          /* TEXT */
        )
      ])) : vue.createCommentVNode("v-if", true),
      vue.createElementVNode("view", { class: "cards-grid" }, [
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($props.cards, (cardData, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              key: index,
              class: "card-item"
            }, [
              cardData.spreadPosition ? (vue.openBlock(), vue.createElementBlock("view", {
                key: 0,
                ...
                vue.createElementVNode(
                  "text",
                  { class: "position-title" },
                  vue.toDisplayString(cardData.spreadPosition),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode(
                  "text",
                  { class: "position-desc" },
                  vue.toDisplayString(cardData.spreadDescription),
                  1
                  /* TEXT */
                )
              ])) : vue.createCommentVNode("v-if", true),
              vue.createVNode(_component_tarot_card, {
                card: cardData.card,
                reversed: cardData.isReversed,
                "spread-position": cardData.spreadPosition,
                "spread-description": cardData.spreadDescription
              }, null, 8, ["card", "reversed", "spread-position", "spread-description"])
            ]);
          }),
          128
          /* KEYED_FRAGMENT */
  ...
  const __easycom_5 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-637fd36b"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/uni_modules/uni-section/components/uni-section/uni-section.vue"]]);
  const en = {
  ...
  const __easycom_6 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-9245e42c"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/uni_modules/uni-load-more/components/uni-load-more/uni-load-more.vue"]]);
  const _sfc_main$7 = {
    name: "uniList",
    "mp-weixin": {
      options: {
  ...
  const UniList = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-c2f1266a"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  const _sfc_main$6 = {
    name: "UniBadge",
    emits: ["click"],
    props: {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-c97cb896"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/uni_modules/uni-badge/components/uni-badge/uni-badge.vue"]]);
  const _sfc_main$5 = {
    name: "UniListItem",
  ...
  const UniListItem = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-c7524739"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/uni_modules/uni-list/components/uni-list-item/uni-list-item.vue"]]);
  const _sfc_main$4 = {
    name: "UniGrid",
    emits: ["change"],
    props: {
  ...
  const UniGrid = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-07acefee"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/uni_modules/uni-grid/components/uni-grid/uni-grid.vue"]]);
  const _sfc_main$3 = {
    name: "UniGridItem",
    inject: ["grid"],
    props: {
  ...
  const UniGridItem = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-7a807eb7"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/uni_modules/uni-grid/components/uni-grid-item/uni-grid-item.vue"]]);
  class AdvancedRandomGenerator {
    ...
    mersenne(seed = this.seed) {
      ...
      for (let i2 = 1; i2 < n2; i2++) {
        mt2[i2] = 1812433253 * (mt2[i2 - 1] ^ mt2[i2 - 1] >>> 30) + i2 >>> 0;
      }
      return mt2[n2 - 1];
    }
    // ==================== 核心随机方法 ====================
    ...
    drawWithSpread(spreadConfig, method = "auto") {
      const cardCount = (spreadConfig == null ? void 0 : spreadConfig.cardCount) || 1;
      const cards = this.drawMultipleCards(cardCount, method);
      return cards.map((card, index) => {
        var _a, _b;
        return {
          ...card,
          spreadPosition: ((_a = spreadConfig == null ? void 0 : spreadConfig.positions) == null ? void 0 : _a[index]) || `位置${index + 1}`,
          spreadDescription: ((_b = spreadConfig == null ? void 0 : spreadConfig.descriptions) == null ? void 0 : _b[index]) || ""
        };
      });
    }
    // ==================== 测试方法 ====================
  ...
  class SeedGenerator {
    ...
    static fromText(text) {
      ...
      for (let i2 = 0; i2 < text.length; i2++) {
        seed = (seed * 31 + text.charCodeAt(i2)) % 2 ** 31;
      }
      return seed;
    }
    // 问题种子 - 使用完整的随机生成器
    ...
    static fromDateTime(customTime = null) {
      const date = customTime ? new Date(customTime) : /* @__PURE__ */ new Date();
      return date.getTime();
    }
    // 复合种子
  ...
  const _sfc_main$2 = {
    ...
    data() {
      return {
        ...
        customTime: null,
        drawnCards: [],
        // 格式: { card: Object, isReversed: Boolean }
        randomParams: null,
    ...
    methods: {
      ...
      handleSeedChange(seed) {
        this.currentSeed = typeof seed === "string" ? SeedGenerator.fromText(seed) : Number(seed);
        this.updateRandomParams();
        uni.showToast({
          title: "种子已设置",
          icon: "success"
      ...
      saveToHistory() {
        ...
        const history = {
          ...
          cards: this.drawnCards.map((cardData) => ({
            ...
            drawTime: (/* @__PURE__ */ new Date()).toISOString()
          })),
      ...
      shareResult() {
        ...
        const cardNames = this.drawnCards.map(
          (cardData) => `${cardData.card.name}${cardData.isReversed ? "(逆位)" : ""}`
        ).join("、");
        const spreadInfo = ((_b = (_a = this.drawSettings) == null ? void 0 : _a.spreadConfig) == null ? void 0 : _b.name) ? `牌阵: ${this.drawSettings.spreadConfig.name}
` : "";
        uni.showModal({
          title: "分享抽牌结果",
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_draw_settings = resolveEasycom(vue.resolveDynamicComponent("draw-settings"), __easycom_0$3);
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
        ...
        default: vue.withCtx(() => {
          ...
          return [
            vue.createVNode(_component_uni_card, {
              ...
              default: vue.withCtx(() => [
                vue.createVNode(_component_draw_settings, { onSettingsChange: $options.onDrawSettingsChange }, null, 8, ["onSettingsChange"])
              ]),
              _: 1
              /* STABLE */
            }),
            vue.createVNode(_component_uni_card, {
              ...
              default: vue.withCtx(() => [
                vue.createVNode(_component_seed_input, {
                  ref: "seedInput",
                  onSeedChange: $options.handleSeedChange,
                  onQuestionChange: $options.handleQuestionChange,
                  onTimeChange: $options.handleTimeChange
                }, null, 8, ["onSeedChange", "onQuestionChange", "onTimeChange"])
              ]),
              _: 1
              /* STABLE */
            }),
            vue.createElementVNode("view", { class: "action-buttons" }, [
              vue.createElementVNode("button", {
                onClick: _cache[0] || (_cache[0] = (...args) => $options.drawCards && $options.drawCards(...args)),
                class: "draw-btn",
                disabled: $data.drawing
              }, [
                !$data.drawing ? (vue.openBlock(), vue.createElementBlock("text", { key: 0 }, "🎴 开始抽牌")) : (vue.openBlock(), vue.createElementBlock("text", { key: 1 }, "抽牌中..."))
              ], 8, ["disabled"]),
              vue.createElementVNode("button", {
            ...
            $data.drawnCards.length > 0 ? (vue.openBlock(), vue.createBlock(_component_draw_result, {
              key: 0,
              cards: $data.drawnCards,
              "spread-config": (_a = _ctx.drawSettings) == null ? void 0 : _a.spreadConfig
            }, null, 8, ["cards", "spread-config"])) : vue.createCommentVNode("v-if", true),
      ...
      vue.createVNode(
        ...
        {
          default: vue.withCtx(() => [
            vue.createElementVNode("view", { class: "loading-popup" }, [
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-1cf27b2a"], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/pages/index/index.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        historyList: [],
    ...
    methods: {
      ...
      loadHistory() {
        try {
          ...
          formatAppLog("error", "at pages/history/history.vue:113", "加载历史记录失败:", error);
          this.historyList = [];
        }
      },
      // 查看历史详情
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "history-container" }, [
      vue.createElementVNode("view", { class: "header" }, [
        vue.createElementVNode("text", { class: "title" }, "📜 抽牌历史"),
        vue.createElementVNode(
          "text",
          { class: "subtitle" },
          "共 " + vue.toDisplayString($data.historyList.length) + " 次记录",
          1
          /* TEXT */
        )
      ]),
      $data.historyList.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        ...
        (vue.openBlock(true), vue.createElementBlock(
          ...
          vue.renderList($data.historyList, (item, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              class: "history-item",
              key: index,
              onClick: ($event) => $options.viewHistoryDetail(item)
            }, [
              vue.createElementVNode("view", { class: "item-header" }, [
                ...
                vue.createElementVNode(
                  "text",
                  { class: "item-seed" },
                  "种子: " + vue.toDisplayString($options.shortenSeed(item.seed)),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("view", { class: "item-cards" }, [
                vue.createElementVNode(
                  "text",
                  { class: "cards-count" },
                  vue.toDisplayString(item.cards.length) + " 张牌",
                  1
                  /* TEXT */
                ),
                vue.createElementVNode("view", { class: "card-previews" }, [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList(item.cards, (card) => {
                      return vue.openBlock(), vue.createElementBlock(
                        "text",
                        {
                          key: card.id,
              ...
              vue.createElementVNode("view", { class: "item-params" }, [
                vue.createElementVNode(
                  "text",
                  { class: "param" },
                  "算法: " + vue.toDisplayString(item.params.method),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode(
                  "text",
                  { class: "param" },
                  "方法: " + vue.toDisplayString(item.params.algorithm),
                  1
                  /* TEXT */
                )
              ])
        ...
        vue.createElementVNode("text", { class: "empty-text" }, "暂无抽牌记录"),
        vue.createElementVNode("text", { class: "empty-subtext" }, "返回首页开始抽牌吧")
      ])),
      vue.createElementVNode("view", { class: "action-buttons" }, [
        vue.createElementVNode("button", {
      ...
      vue.createVNode(
        ...
        {
          default: vue.withCtx(() => [
            $data.selectedHistory ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "detail-popup"
            }, [
              vue.createElementVNode("text", { class: "popup-title" }, "抽牌详情"),
              vue.createElementVNode("view", { class: "popup-time" }, [
                vue.createElementVNode(
                  "text",
                  null,
                  "时间: " + vue.toDisplayString($options.formatTime($data.selectedHistory.timestamp)),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("view", { class: "popup-seed" }, [
                vue.createElementVNode(
                  "text",
                  null,
                  "种子: " + vue.toDisplayString($data.selectedHistory.seed),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("view", { class: "popup-cards" }, [
                vue.createElementVNode("text", { class: "cards-title" }, "抽到的牌:"),
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList($data.selectedHistory.cards, (card) => {
                    return vue.openBlock(), vue.createElementBlock("view", {
                      class: "popup-card",
                      key: card.id
                    }, [
                      vue.createElementVNode(
                        "text",
                        { class: "card-name" },
                        vue.toDisplayString(card.name) + " (" + vue.toDisplayString(card.enName) + ")",
                        1
                        /* TEXT */
                      ),
                      vue.createElementVNode(
              ...
              vue.createElementVNode("view", { class: "popup-params" }, [
                vue.createElementVNode("text", { class: "params-title" }, "随机参数:"),
                vue.createElementVNode(
                  "text",
                  null,
                  "算法: " + vue.toDisplayString($data.selectedHistory.params.method),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode(
                  "text",
                  null,
                  "抽牌数: " + vue.toDisplayString($data.selectedHistory.params.cards),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode(
                  "text",
                  null,
                  "方法: " + vue.toDisplayString($data.selectedHistory.params.algorithm),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("button", {
                onClick: _cache[2] || (_cache[2] = (...args) => $options.closeDetail && $options.closeDetail(...args)),
                class: "close-btn"
              }, "关闭")
            ])) : vue.createCommentVNode("v-if", true)
          ]),
  ...
  const PagesHistoryHistory = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/12131/Desktop/tarrotGenerate/pages/history/history.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/12131/Desktop/tarrotGenerate/App.vue"]]);
  function createApp() {
